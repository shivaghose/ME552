...
Figure \ref{accelPins} shows the arrangement of the pins on the accelerometer. 

\begin{figure}[hbt]
\begin{center}
\includegraphics[width = 9cm]{ADXL335Pins.png}
...
These pins connect various elements of the accelerometer chip to ground. The PCB provides a connection for ground from the power supply and internally connects this to all of the COM pins.\\
