...
The Bode plot of the digital low pass filter can be seen in figure \ref{bode_LPF}. As you can see, its response is similar to a physical low pass filter. While generating the Bode plots, we assumed perfect
