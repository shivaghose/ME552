...
The high pass filters suppresses low-frequency noise. It is used in conjunction with Gyroscope to suppress low-frequency transients. Digitally, it is implemented as the following algorithm:
\begin{verbatim}
