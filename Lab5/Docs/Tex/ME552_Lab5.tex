...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        Condition & Natural Freq. (Hz)  & Natural Freq. (rad/sec) & Damped Freq. (Hz) &  Damped Freq. (rad/sec) & Damping Ratio, $\zeta$   \\ \hline
        Loaded   & 0   & 0 & 0 &  0 & 0.4616\\ 
        Unloaded   & 0    & 0 & 0 & 0 & 0.5552         \\         
        \hline
    \end{tabular}
\caption{Average natural and damped frequency values. \xxx{Will fill in when I get data off lab computer}}
\label{q3ai_2}
\end{center}
\end{table}
